...
<div class="container">
  ...
  <ol class="breadcrumb">
     <li class="breadcrumb-item active"><i class="fa fa-list"> </i> EDITAR LISTADO DE PRODUCTOS </li>
  </ol>
 <form method="post">
 <?php foreach ($consulta as $key ): ?>
    <input type="hidden" name="idproducto" value="<?php echo $key['idproducto']; ?>">
      ...
      <select class="form-control chosen-select" id="idcategoria" name="idcategoria">     
         ...
         <CENTER>
            <button type="submit" class="btn btn-primary" name="editarProductos">Guardar</button>
         </CENTER>
         <br>
       </form>
 <?php endforeach ?>
